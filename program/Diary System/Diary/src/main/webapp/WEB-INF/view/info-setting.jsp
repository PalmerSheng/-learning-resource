                ...
                <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                    ...
                    <form class="am-form am-form-horizontal" id="information-form" action="${ctx}/${userid}/update" method="post" data-am-validator>
                        ...
                        <div class="am-form-group">
                            ...
                            <input type="hidden"  id="hidden_field" value="${user.sex}"/>
                            <script>
                          
                            $(document).ready(function(){
                            	  var str=$("#hidden_field").val();
                                 ...
                                 /* $('#sex').find('option').eq($('#hidden_field').val()).attr('selected', true);  */
                            </script>
                        </div>
                        <div class="am-form-group">
                            <label for="sex" class="am-u-sm-2 am-form-label">所在组</label>
                            <div class="am-u-sm-10">
                                <select id="groups" name="groups" data-am-selected>
                                    <option selected></option>
                            ...
                            <input type="hidden"  id="hidden_field_groups" value="${user.groups}"/>
                            <script>
                          
                            $(document).ready(function(){
                            	  var str=$("#hidden_field_groups").val();
                            	  console.log("this.val"+str);
                ...
                <div class="am-tab-panel am-fade" id="tab2">
                    <form class="am-form am-form-horizontal" action="${ctx}/${userid}/upload" enctype="multipart/form-data" method="post" onsubmit="return checkFileType();" style="text-align: center;">
                        <div style="text-align: center;margin-bottom: 10px">
                            <img class="am-circle" src="/photos/upload/${user.userid}/${user.userid}.jpg" onerror="this.src='/photos/upload//default/default.jpg'" width="140" height="140" alt="${user.nickname}"/>
                        </div>
