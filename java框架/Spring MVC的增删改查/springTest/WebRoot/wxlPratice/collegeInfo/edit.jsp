...
<body >
 ...
 <div class="margin clearfix"  style="padding-bottom:5px;">	
      ...
      <form method="post" action="" id="addNewCollage">
	   ...
	   <input type="hidden" id="collageid" name="collageid" value=""/>
	    <table  class="table table-striped table-bordered table-hover" id="sample-table">
			  <tr>
				...
				<td style="" id="usercodes">				
                    <input  type="text" style="width:80%;" name="collagecode" id="collagecode" value=""/> 
				</td>	
			  </tr>
			  <tr>
				...
				<td style="" id="usernames">				
                    <input  type="text" style="width:80%;" name="collagename" id="collagename" value=""/> 
				</td>	
			  </tr>
	        </table>
	         <div style="text-align:center">
	  		 <input type="button" class="btn btn-success" onclick="ObjCollage_Edit.btnOK();" style="width:110px;" value="确定" /> 
	  		 <input type="button" class="btn btn-default" onclick="ObjCollage_Edit.btnCancal()" style="width:110px;" value="取消" /> 
	  		</div>
	  		</div>
	  </form>
    </div>     
